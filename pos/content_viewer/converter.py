...
def m4v_to_mp4(m4v_url, AppName):
    ...
    if system_os == "Windows":
        ...
        m4v_path = os.path.join(m4v_path, f'storage/{str(AppName)}/content/videos/m4v')
        # print("m4v_path ", m4v_path)
        mp4_path = os.path.join(mp4_path, f'storage/{str(AppName)}/content/videos/mp4')
        m4v_filename = m4v_url.split('/')[-1]
    ...
    if not os.path.exists(mp4_path):
        try:
            ...
            print(f"Problem converting {m4v_url}")
            return None
...
def wav_to_mp3(wav_url, AppName):
    ...
    if not os.path.exists(mp3_path):
        try:
            ...
            print(f"Problem converting {wav_url}")
            return None
